        ...
        <div class="col-md-10">
            ...
            <div class="form-container">
                ...
                <form id="formFornecedor" action="" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <input type="text" class="form-control bg-light" id="cnpj_empresa" name="cnpj_empresa" placeholder="CNPJ" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <select class="form-select bg-light text-muted" id="pais" name="pais">
                                <option value="Brasil" selected>Brasil</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <select class="form-select bg-light text-muted" id="estado" name="estado" required>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <select class="form-select bg-light text-muted" id="municipio" name="municipio" required>
                    ...
                    <div class="text-center mb-5">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="input-group" style="max-width: 500px;">
                                <select class="form-select bg-light text-muted" id="ramo_atuacao" name="ramo_atuacao">
                    ...
                    <div class="row mb-3 mt-5">
                        <div class="col-md-6">
                            <input type="text" class="form-control text-center" id="cnpj_usuario" name="cnpj_usuario" placeholder="CNPJ" required>
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control text-center" id="nome_usuario" name="nome_usuario" placeholder="Nome" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="password" class="form-control border-end-0" id="senha" name="senha" placeholder="Senha" required>
                                <span class="input-group-text bg-white border-start-0"><i class="bi bi-eye-fill text-muted"></i></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="password" class="form-control border-end-0" id="repetir_senha" name="repetir_senha" placeholder="Repetir Senha" required>
                                <span class="input-group-text bg-white border-start-0"><i class="bi bi-eye-fill text-muted"></i></span>
                            </div>
                        </div>
                    </div>
